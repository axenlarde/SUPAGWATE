...
public abstract class BaseLaunchPanel extends JPanel implements ActionListener, MouseListener
	 ...
	 * Constructor
	 ***************/
	public BaseLaunchPanel(JFrame mainFrame, String panelTitle, ArrayList<OptionLine> myOptionList, actionType action)
		{
	...
	protected void manageSelectedBox()
		...
		for(String s : Variables.getAllowedItemsToProcess())
			{
			Variables.getLogger().debug("- "+s);
			}
		}
